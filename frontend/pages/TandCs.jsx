...
const TandCs = () => (
  <>
    <NextSeo title="Terms and Conditions" description="The terms and conditions of the site." />
    <Card>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to WellFit.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to WellFit.
          </p>
        </li>
        <li>
          <p>
