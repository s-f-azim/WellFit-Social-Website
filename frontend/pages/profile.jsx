              ...
              <Tabs className="content">
                <TabPane tab="Qualifications">
                  <div className="qualifications">
                    ...
                    <h3>
                      Speciality: {user ? (user.speciality ? user.speciality : 'Non Given') : ''}
                    </h3>
                    <h3>
                      Sessions:
                      {user
            ...
            <Card>
              <Tabs defaultActiveKey="1">
                <TabPane tab="About" key="1">
                  ...
                  <Row>
                    <h3 className="loc">
                      Location: {user ? (user.location ? user.location : 'Not given') : 'Not given'}
                    </h3>
                  </Row>
                  <Row style={{ float: 'right' }}>
                    <h3 className="age">
          ...
          <Row>
            <Card>
              <Tabs>
                ...
                <TabPane tab="My Feed" key="3">
                  <UserFeed id={session.user._id} />
                </TabPane>
              </Tabs>
            </Card>
          </Row>
