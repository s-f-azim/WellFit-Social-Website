  ...
  return (
    <>
      ...
      className="container-card"
        ...
        actions={[
          <Button size="large" type="primary" onClick={previous} disabled={!valid} block>PREVIOUS</Button>,
          <Button size="large" type="primary" onClick={next} disabled={!valid} block>NEXT</Button>,
        ]}
      >
          <Form
            name="questionnaire"
      ...
      <Col span={23}>
            ...
            >
              ...
              <Form.Item
                ...
                name="weight"
                rules={[
                  { type: "number", min: 0, message: "Please enter positive numbers only" },
                ]}
              >
                <InputNumber />
              </Form.Item>
              ...
              <Card>
              <Card.Grid>
              <Form.Item label="Preferred instructor's gender?" name="gender">
                <Select allowClear>
              ...
              <Card>
              <Card.Grid>
              <Form.Item label="What training equipment do you have available?" name="fitnessLevel">
