...
it('Should get all instructors with x in name', async () => {
  const response = await request(app).get(
    '/api/users/instructors?q=x&&age=&&gender='
  );
...
it('Should get all instructors with name x and who are female', async () => {
  const response = await request(app).get(
    '/api/users/instructors?q=x&&age=&&gender=Female'
  );
...
it('Should get all with letter a', async () => {
  const response = await request(app).get(
    '/api/users/instructors?q=a&&age=&&gender='
  );
  expect(response.body.data.length).toBe(6);
});
...
it('Should get all non-binary instructors', async () => {
  const response = await request(app).get(
    '/api/users/instructors?q=&&age=&&gender=Non-Binary'
  );
  expect(response.body.data.length).toBe(1);
});
...
it('Should get all female instructors', async () => {
  const response = await request(app).get(
    '/api/users/instructors?gender=Female'
  );
...
it('Should get all instructors', async () => {
  const response = await request(app).get(
    '/api/users/instructors?q=&&gender=&&age=0'
  );
  expect(response.body.data.length).toBe(6);
});
...
it('Should get all instructors ages 15-25', async () => {
  const response = await request(app).get(
    '/api/users/instructors?q=&&gender=&&age=20'
  );
...
it('Should get all instructors ages 30-40', async () => {
  const response = await request(app).get(
    '/api/users/instructors?q=&&gender=&&age=35'
  );
  expect(response.body.data.length).toBe(2);
});
...
it('Should get all instructors age 50-60', async () => {
  const response = await request(app).get(
    '/api/users/instructors?q=&&gender=&&age=55'
  );
  expect(response.body.data.length).toBe(0);
});
...
it('Should get all instructors over 62', async () => {
  const response = await request(app).get(
    '/api/users/instructors?q=&&gender=&&age=70'
  );
  expect(response.body.data.length).toBe(1);
});
...
it('Should get all female instructors with a in their name between age 15-25', async () => {
  const response = await request(app).get(
    '/api/users/instructors?q=a&&gender=Female&&age=20'
  );
  expect(response.body.data.length).toBe(0);
});
...
it('Should get all female instructors with a in their name between age 25-35', async () => {
  const response = await request(app).get(
    '/api/users/instructors?q=a&&gender=Female&&age=30'
  );
  expect(response.body.data.length).toBe(2);
});
...
it('Should get all male instructors with a in their name between 25-35', async () => {
  const response = await request(app).get(
    '/api/users/instructors?q=a&&gender=Male&&age=20'
  );
  expect(response.body.data.length).toBe(1);
});
...
it('Should get all instructors with tag Cycling', async () => {
  const response = await request(app).get(
    '/api/users/instructors?tags=Cycling'
  );
  expect(response.body.data.length).toBe(2);
});
...
it('Should get all instructors with tag Cycling', async () => {
  const response = await request(app).get(
    '/api/users/instructors?tags=Cycling,Sweat'
  );
  expect(response.body.data.length).toBe(1);
});
...
it('Should return no Instructors with invalid tag', async () => {
  const response = await request(app).get(
    '/api/users/instructors?tags=GymLife'
  );
  expect(response.body.data.length).toBe(0);
});
// assert get all instructors
it('Should return no Instructors with invalid tag', async () => {
  const response = await request(app).get('/api/users/instructors?tags=');
  expect(response.body.data.length).toBe(6);
});
// assert get one instructor
it('Should return one instructor with all filters set', async () => {
  const response = await request(app).get(
    '/api/users/instructors?q=a&&gender=Male&&age=20&&tags=Cardio'
  );
  console.log(response);
  expect(response.body.data.length).toBe(1);
});
// assert get one instructor
it('Should return no instructor with limit set to 0', async () => {
  const response = await request(app).get(
    '/api/users/instructors?q=&&gender=&&age=&&tags=&&offset=0&&pageSize=0'
  );
  console.log(response);
  expect(response.body.data.length).toBe(0);
});
it('Should return 5 instructor with limit set to 5 and offset to 0', async () => {
  const response = await request(app).get(
    '/api/users/instructors?q=&&gender=&&age=&&tags=&&offset=0&&pageSize=5'
  );
  console.log(response);
  expect(response.body.data.length).toBe(5);
});
it('Should return 1 instructor with limit set to 5 and offset to 5', async () => {
  const response = await request(app).get(
    '/api/users/instructors?q=&&gender=&&age=&&tags=&&offset=5&&pageSize=5'
  );
  console.log(response);
  expect(response.body.data.length).toBe(1);
});
it('Should return 0 instructor with limit set to 5 and offset to 10', async () => {
  const response = await request(app).get(
    '/api/users/instructors?q=&&gender=&&age=&&tags=&&offset=10&&pageSize=5'
  );
  console.log(response);
  expect(response.body.data.length).toBe(0);
});
